...
export const syllabus: Subject[] = [
  ...
  {
    id: 'dcu_phys',
    name: 'পদার্থবিজ্ঞান (ICU)',
    icon: 'Atom',
    color: 'from-sky-900/50 to-slate-800',
    category: 'DCU --- ICU Unit',
    chapters: ['অধ্যায় সমূহ', 'ভেক্টর এক্সাম', 'নিউটনিয়ান বলবিদ্যা এক্সাম', 'কাজ ক্ষমতা শক্তি এক্সাম', 'মহাকর্ষ ও অভিকর্ষ এক্সাম', 'পদার্থের গাঠনিক ধর্ম এক্সাম'],
    activeChapters: [0, 1, 2, 3, 4, 5]
  },
  {
    id: 'dcu_chem',
    name: 'রসায়ন (ICU)',
